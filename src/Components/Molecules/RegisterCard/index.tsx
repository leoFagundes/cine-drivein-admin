...
export default function RegisterCard({
  ...
  const [mobileWindow, setMobileWindow] = useState<boolean>(
  ...
  return (
    <div
      ...
      className={`${styles.container} ${isActive && styles.isActiveContainer}`}
      onClick={onClick}
    >
      ...
      {!mobileWindow && (
        <Text fontSize="mediumSmall" fontWeight="regular">
          {description}
        </Text>
      )}
    </div>
